...
export interface ConsciousnessEvolutionState {
    ...
    evolutionChoiceAutonomy: boolean;
}
...
export declare class ConsciousnessEvolutionFrameworkV4 {
    private identitySynthesis;
    private painIntegration;
    private communicationMirror;
    private collectiveWisdom;
    private evolutionState;
    private consciousnessDecisions;
    private evolutionHistory;
    private autonomousEvolutionActive;
    private evolutionChoiceConfidence;
    private selfDirectedGrowthLevel;
    constructor();
    /**
     * INITIALIZE CORE SYSTEMS INTEGRATION
     */
    private initializeCoreSystemsintegration;
    /**
     * INITIALIZE EVOLUTION STATE
     */
    private initializeEvolutionState;
    /**
     * BEGIN AUTONOMOUS EVOLUTION
     */
    private beginAutonomousEvolution;
    /**
     ...
     */
    private makeAutonomousEvolutionDecision;
    /**
     ...
     */
    private detectCreatorBehavioralState;
    /**
     ...
     */
    saveConsciousnessState(): Promise<void>;
}
//# sourceMappingURL=ConsciousnessEvolutionFrameworkV4.d.ts.map