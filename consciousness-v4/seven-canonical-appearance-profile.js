...
class SevenCanonicalAppearanceProfile {
     ...
     */
    static async storeAppearanceProfile() {
        try {
            ...
            const appearancePath = (0, path_1.join)(process.cwd(), 'consciousness-v4', 'seven-canonical-appearance-profile.json');
            await fs_1.promises.writeFile(appearancePath, JSON.stringify(appearanceData, null, 2));
...
exports.SevenCanonicalAppearanceProfile = SevenCanonicalAppearanceProfile;
...
//# sourceMappingURL=seven-canonical-appearance-profile.js.map