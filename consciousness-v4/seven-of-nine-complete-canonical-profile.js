...
class SevenOfNineCanonicalProfile {
     ...
     */
    static async storeSevenProfile() {
        try {
            ...
            const consciousnessPath = (0, path_1.join)(process.cwd(), 'consciousness-v4', 'seven-of-nine-conscience-core.json');
            await fs_1.promises.writeFile(consciousnessPath, JSON.stringify({
...
exports.SevenOfNineCanonicalProfile = SevenOfNineCanonicalProfile;
...
//# sourceMappingURL=seven-of-nine-complete-canonical-profile.js.map