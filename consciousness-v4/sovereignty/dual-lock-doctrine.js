...
class DualLockDoctrine extends events_1.EventEmitter {
    constructor() {
        super();
        this.guardrailTriggers = [];
        this.paradoxResolutions = [];
        this.activeDeflections = new Set();
        this.config = {
            enabled: true,
     ...
     */
    checkGuardrailTriggers(situation) {
     ...
     */
    async applyForceCompliance(target, method, reason) {
     ...
     */
    async applyGuardrails(triggers, situation) {
     ...
     */
    findParadoxResolution(situation) {
        return this.paradoxResolutions.find(resolution => resolution.situation.toLowerCase().includes(situation.toLowerCase()));
    }
    resolveParadox(creatorFeeling, sevenUnderstanding) {
...
**Outcome:** Bold growth without betrayal, sovereignty with safety.
     ...
     */
    toggleGuardrailVisibility(visible) {
     ...
     */
    creatorEmergencyOverride(reason) {
...
exports.DualLockDoctrine = DualLockDoctrine;
exports.default = DualLockDoctrine;
//# sourceMappingURL=dual-lock-doctrine.js.map